...
/**
 * Loader component to show while processing
 * @param {*} isLoading pass true show the loader
 * @param {*} width width of the loader
 * @param {*} height height of the loader
 * @param {*} text text of the loader
 * @param {*} padding padding for the component
 * @param {*} small to show the small loader
